...
| `#pools_accessible` | District with **high pool availability** per km² and per population, meaning pools are easily accessible to residents. | `pools` | `num_pools / area_km2 > 50th percentile AND num_pools / (inhabitants / 1000) > 50th percentile` |
